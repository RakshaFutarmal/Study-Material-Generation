...
class AudioService:
    ...
    def audio_prompt(self, subtopics, levels):
       ...
       Introduction: Briefly overview the topic of {subtopics} in 1-2 bullet points and explain its importance for a {levels} audience.

       Problem Statement : Describe the core problem or challenge within {subtopics} using 1-2 concise bullet points.

       Importance of the Topic : Highlight why {subtopics} matters with 1-2 key points, including relevant statistics, studies, or expert opinions.

       Key Concepts : Define and explain 1-2 key ideas or frameworks within {subtopics}, suitable for the {levels} audience.

       Solution or Approach : Outline a proposed solution or approach to the core challenges in {subtopics}, focusing on 1-2 key points.

       Benefits of the Solution : Discuss why this solution is effective, with 1-2 supporting points.

       Case Study/Example : Present a real-world example or case study illustrating {subtopics}, with 1-2 bullet points tailored to the audience's {levels}.

       Actionable Insights : Summarize practical takeaways or insights in 1-2 points, emphasizing actionable steps or strategies for the audience.

       Conclusion : Recap the most important points from the presentation in 1-2 concise bullet points.

       Future Outlook: Provide 1-2 predictions or recommendations for future trends in {subtopics}.
       """
