...
def content(self, subtopic, level):
    ...
    query = f"""
                  ...
                  "Table of content" : Generate 3-4 points for {subtopic},
                          ...
                          "key_points": [
                              Provide a brief definition or
                              introduction to {subtopic}.,
                              Explain why {subtopic} is important
                              in the context of {level} audience.,
                              Mention any key applications
                              or uses of {subtopic}.                                                

                          "slide_2": Core Problem in {subtopic},
                          "key_points": [
                              Outline the main problem or
                              challenge related to {subtopic}.,
                              Why is this problem significant
                              for {level} audience?,
                              Provide examples of this challenge
                              in real-world scenarios.

                          "slide_3": Importance of {subtopic},
                          "key_points": [
                              Highlight why {subtopic} is important
                              for professionals or learners at the {level} level.,
                              Discuss its impact on the industry,
                              technology, or society.,
                              Include statistics or research data
                              if available.

                          "slide_4": Key Concepts in {subtopic},
                          "key_points": [
                              Define and explain 3-5 key concepts
                              or terms within {subtopic}.,
                              Provide explanations at a {level}-
                              appropriate level of detail.,
                              Use analogies, if necessary, for
                              easier understanding at the {level} level.
                          ...
                          "key_points": [
                              Describe a known solution or
                              approach to address challenges in {subtopic}.,
                              Explain why this solution is
                              effective at the {level} of understanding.,
                          ...
                          "key_points": [
                              ...
                              proposed solution in {subtopic}.,
                              Provide evidence of its effectiveness,
                              tailored to the {level} audience.,
                              Compare this solution to alternative
                          ...
                          "key_points": [
                              ...
                              where {subtopic} was applied successfully.,
                              Discuss the challenges faced and how they
                              were overcome.,
                          ...
                          "key_points": [
                              Summarize the key takeaways for
                              {level} learners or professionals.,
                              Provide practical steps they can
                              apply to their work or studies.,
                              Discuss how {subtopic} can be integrated
                              into real-life scenarios for their benefit.
                          ...
                          "key_points": [
                              ...
                              Tailor the conclusion to the {level}
                              audience, focusing on what they need to retain.,
                              Encourage further exploration or
                              study of {subtopic}.
                          ...
                          "key_points": [
                              Provide predictions or recommendations
                              for future trends in {subtopic}.,
                              Explain how the field may evolve,
                              especially for the {level} audience.,
                              Highlight any opportunities for
                              further research or innovation.
...
def create_presentation_from_content(self, slides_content, image_path):
    """
    Create a PowerPoint presentation from the parsed content.
    """
    first_slide = self.presentation.slides.add_slide(self.presentation.slide_layouts[5])
    img_left = Inches(0)
    img_top = Inches(0)
    img_width = Inches(10)
...
def main(self):
    ...
    for subtopic, level in zip(subtopics, levels):
        content = self.content(subtopic, level)
        slides_content = self.parse_generated_content(content)
        image_path = "/home/tntra/Documents/NeoTech/professional-mobility-test-develop/NeoTech Video Content/Sample Tntra format.png"
        ppt_file = self.create_presentation_from_content(slides_content, image_path)
